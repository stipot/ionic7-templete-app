...
export class FrontLayoutComponent implements OnInit {
  ...
  comp_list: Component_Item[] = [
    ...
    { c_name: "Shopping", c_desc: "Компонент Shopping предоставляет пользователям информацию о списке товаров", link: "/shopping" },    { c_name: "Get Forms", c_desc: "Страница для подключения вашей формы или сайта внутри приложения", link: "/getforms" },    { c_name: "cryptorates", c_desc: "Компонент CryptoRates предоставляет пользователям актуальную информацию о ценах на популярные криптовалюты.", link: "/cryptorates" },
    ...
    { c_name: "Spectrum Mixer", c_desc: "Компонент для симуляции и объединения спектров.", link: "/spectrmixer" },
