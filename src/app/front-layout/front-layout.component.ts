...
export class FrontLayoutComponent implements OnInit {
  ...
  comp_list: Component_Item[] = [
    ...
    {c_name: "Terms of service", c_desc: "Компонент разработан для прохождения условий использования в приложени Angular",link:"/terms-of-service"},
    ...
    {c_name: "VideoPlayer", c_desc: "Компанент предназначенный для воспроизведения файлов мультимедиа-содержимого.",link:"/videoplayer"},
